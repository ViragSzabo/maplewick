...
public class Vegetable extends Ingredient implements Cookable, Storable {

    /** Constructor */
    public Vegetable(String name, LocalDate expirationDate, double quantity) {
